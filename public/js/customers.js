    ...
    return (function () {
        ...
        $(function () {
            var dt_user_table = $('.datatables-customers'),
                select2 = $('.select2'),
                userView = baseUrl + 'admin/customer/',
                ...
                var dt_user = dt_user_table.DataTable({
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            enabled: hasPermission('customer.create')
                        }
                    ],
            ...
            $(document).on('click', '.delete-record', function () {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: baseUrl + `admin/customer/${user_id}`,
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
            ...
            $(document).on('click', '.create-record', function () {
                window.location.href = baseUrl + 'admin/customer/create';
			});
            // edit record
            $(document).on('click', '.edit-record', function () {
                var user_id = $(this).data('id');
                window.location.href = baseUrl + 'admin/customer/' + user_id + '/edit';
                ...
                // get data
                // $.get(''.concat(baseUrl, 'admin/customer/').concat(user_id, '/edit'), function (data) {
                //     $('#user_id').val(data.id);
