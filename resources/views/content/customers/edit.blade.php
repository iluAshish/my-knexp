...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light"><a href="{{ route('customer.list') }}">Customers</a> / Edit</span>
            </h4>
            <div class="card">
                        ...
                        <div class="row">
                            <div class="mb-3 col-sm-6">
                                ...
                                <input required type="text" class="form-control" id="first_name" placeholder="First Name"
                                       name="first_name" aria-label="First Name" value="{{ $customer->first_name }}">
                                @error('first_name')
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <input required type="text" class="form-control" id="last_name" placeholder="Last Name"
                                       name="last_name" aria-label="Last Name" value="{{ $customer->last_name }}">
                                @error('last_name')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <input required type="tel" class="form-control" id="phone" placeholder="+971560000000"
                                       aria-label="Phone"
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <input required type="text" class="form-control" id="address" placeholder="Address"
                                       name="address" aria-label="Address" value="{{ $customer->address }}">
                                @error('address')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
