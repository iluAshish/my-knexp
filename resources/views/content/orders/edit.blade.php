...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light"><a href="{{ route('order.list') }}">Orders</a> / Edit</span>
            </h4>
            ...
            <div class="card">
                ...
                <form class="add-new-user pt-0 needs-validation" id="addNeworderForm"
                      action="{{ route('order.update', ['order' => $order->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3  col-sm-6">
                                ...
                                <input type="text" class="form-control" required id="first_name"
                                       ...
                                       value="{{ $orderCustomer->first_name }}">
                                @error('first_name')
                            ...
                            <div class="mb-3  col-sm-6">
                                ...
                                <input type="text" class="form-control" required id="last_name" placeholder="Last Name"
                                       name="customer[last_name]" aria-label="Last Name"
                                       value="{{ $orderCustomer->last_name }}">
                                @error('last_name')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3  col-sm-6">
                                ...
                                <input type="email" class="form-control" required id="email" placeholder="Email"
                                       aria-label="Email" name="customer[email]" value="{{ $orderCustomer->email }}">
                                @error('email')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3  col-sm-6">
                                ...
                                <input type="tel" class="form-control" required id="phone" placeholder="+971560000000"
                                       aria-label="Phone" name="customer[phone]" value="{{ $orderCustomer->phone }}">
                                @error('phone')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3  col-sm-6">
                                ...
                                <textarea class="form-control" required id="address" aria-label="Address"
                                          name="customer[address]">{{ $orderCustomer->address }}</textarea>
                                @error('address')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <select class="form-select select2" required id="branch_id" name="branch_id"
                                    ...
                                    @foreach($branches as $branch)
                                        <option @if($branch->id == $order->origin) selected
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <select class="form-select select2" required id="state_id" name="state_id"
                                    ...
                                    @foreach($states as $state)
                                        <option @if($state->id == $order->destination) selected
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <select class="form-select select2" id="servicetype" name="servicetype"
