...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ url('assets/web/images/main-logo.png') }}" />
...
<body>
    ...
    <header class="top-header">
        <div class="container-ctn">
            <div class="row align-items-center">
                <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-7 col-sm-4 col-12 mob-none">
                    <ul class="list-inline mb-0 top-action">
                        ...
                        {{-- @if($siteInformation->address)
                            <li class="list-inline-item mob-hide-adres">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-5 col-sm-8 col-12 d-flex justify-content-end">
                    ...
                    <div class="container-fluid">
                        <div class="hamburg-menu-wrapper">
                            <a class="navbar-brand" href="{{ url('/') }}">
                                <img src="{{ url('storage/site_information/logo/') . '/' . (isset($siteInformation->logo_webp) ? $siteInformation->logo_webp : '') }}"
                                    class="img-fluid main-logo" {!! (isset($siteInformation->logo_attribute) ? $siteInformation->logo_attribute : '') !!} />
                            </a>
                            <div class="left-menu">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav m-auto align-items-center">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#home" id="menu">
                                        Home
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#counter" id="menu">
                                        About
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <div class="main-search">
                                        <input id="search" type="search" class="form-control search search-input"
                                            name="search" placeholder="Enter Your Tracking Id">
                                        <div class="menu-search-icon" data-bs-toggle="modal"
                                            >
                                            {{-- <img src="{{ url('assets/web/images/icons/menu-search.svg') }}"
                                        ...
                                        <button class="btn mobile-search" type="button" data-bs-toggle="offcanvas"
                                            data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">
                                            {{-- <img src="{{ url('assets/web/images/icons/menu-search.svg') }}" class="img-fluid" data-bs-toggle="modal"> --}}
                                            <div class="comn-search waves-effect waves-light">
                                                <h3>Track</h3>
                                            </div>
                                            </button>
            ...
            <div class="offcanvas offcanvas-start mobile_left_menu" tabindex="-1" id="mobileOffcanvasExample"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link abt" href="#counter">About us</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ser" href="#services">Services</a>
                        </li>
                        <li class="nav-item last">
                            <a class="nav-link car" href="#contact">Contact Us</a>
                        </li>
                    </ul>
    ...
    <section class="hero-slider-wrapper" id="home">
                ...
                @foreach ($sliders as $key => $slider)
                    <div>
                        <div class="image-slide">
                            <img src="{{ url('storage/images/slider') . '/' . $slider->image_webp }}"
                                {!! @$slider->image_attribute !!}>

                            {{-- {!! Helper::printImage($slider,'image','image_webp','alt="home slider"','img-fluid',null,'1000','1920') !!} --}}
                            <div class="slider-wrapper">
                                <div class="slider-sml-txt">
                                    @if (@$slider->sub_title != '')
                                        <div class="mid-title">
        ...
        <!-- <img src="images/slider-crane.png" class="s-crane" alt=""> -->
    </section>
    <!-- end of hero slider -->
    ...
    @if ($about_us)
        ...
        <!-- approach section -->
        <section class="approach-wrapper" id="counter">
            <div class="common-container-right">
                <div class="row">
                    <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                        <div class="left-wrapper">
                            @if (@$about_us->sub_title != '')
                                <div class="mid-title">
                                    <p>{{ @$about_us->sub_title }}</p>
                                </div>
                            @endif
                            @if (@$about_us->title != '')
                                <div class="larg-txt">
                            ...
                            @endif
                            <ul class="approach-counter list-inline mb-0">
                                @if ($keyfeatures)
                                    @foreach ($keyfeatures as $key => $keyfeature)
                                        <li class="list-inline-item">
                                            <div class="aprch-box1 {{ @$key == 1 ? 'apx-2' : '' }}">
                                                <div class="box">
                                                    @if (@$keyfeature->title != '')
                                                        <div class="discription">
                                                            <p>{{ @$keyfeature->title }}</p>
                                                        </div>
                                                    @endif
                                                    @if (@$keyfeature->counter != '')
                                                        <div class="counter-big">
                                                            <h3 class="counter timer" data-to="{{ @$keyfeature->counter }}"
                                                                data-speed="2000">
                                                                {{ @$keyfeature->counter }} +
                                                            </h3>
                                                            <!-- <strong class="timer count-title count-number aboutCount" data-to="100" data-speed="2000">100+</strong> -->
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="aprch-img">
                                                    <img src="{{ url('storage/images/keyfeature/') }}/{{ @$keyfeature->image_webp }}"
                                                        class="img-fluid" {!! isset($keyfeature->image_attribute) ? $keyfeature->image_attribute : 'alt="Key"' !!}>
                                                </div>
                                            </div>
                                        </li>
                                    @endforeach
                    ...
                    <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                        <div class="right-wrapper">
                            <div class="ap-img">
                                <img src="{{ url('storage/images/about-us/') }}/{{ @$about_us->image_webp }}"
                                    class="img-fluid" alt="approach">
                                <div class="red-box">
                                    <img src="{{ url('assets/web/images/green-square.png') }}" class="img-fluid"
                                        alt="">
                                    <div class="box-content">
                                        @if (@$about_us->title_2 != '')
                                            <div class="solu-title">
                                                <h4>{{ @$about_us->title_2 }}</h4>
                                            </div>
                                        @endif
                                        @if (@$about_us->description_2 != '')
                                            <div class="discription">
                                        ...
                                        <div class="explr">
                                            <a href="javascript:;" class="text-decoration-none"
                                                data-bs-toggle="modal" data-bs-target="#enquiry-modal"><span
                                                    class="arrow-img"><img src="{{ url('assets/web/images/right-square-arrow.png') }}"
                                                        alt=""></span>Enquire Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- why choose section -->
    <section class="why-choose-wrapper" data-aos="fade-up">
        <div class="container-ctn">
            <div class="row">
                <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="left-wrapper">
                        @if (@$why_choose_us->sub_title != '')
                            <div class="mid-title">
                                <p>{{ @$why_choose_us->sub_title }}</p>
                            </div>
                        @endif
                        @if (@$why_choose_us->sub_title != '')
                            <div class="larg-txt">
                        ...
                        @endif
                        <ul class="list-inline mangment mb-0">
                            @if (@$why_choose_us->icon_1 != '')
                                <li>
                                    <div class="flex-wrapper">
                                        ...
                                        <div class="right">
                                            @if (@$why_choose_us->icon_title_1 != '')
                                                <h3>
                                                    {{ @$why_choose_us->icon_title_1 }}
                                                </h3>
                                            @endif
                                            <div class="discription">
                                                @if (@$why_choose_us->icon_desc_1 != '')
                                                    <p>
                                                        {{ @$why_choose_us->icon_desc_1 }}
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="flex-wrapper">
                                    ...
                                    <div class="right">
                                        @if (@$why_choose_us->icon_title_2 != '')
                                            <h3>
                                                {{ @$why_choose_us->icon_title_2 }}
                                            </h3>
                                        @endif
                                        <div class="discription">
                                            @if (@$why_choose_us->icon_desc_2 != '')
                                                <p>
                                                    {{ @$why_choose_us->icon_desc_2 }}
                                                </p>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="flex-wrapper">
                                    ...
                                    <div class="right">
                                        @if (@$why_choose_us->icon_title_3 != '')
                                            <h3>
                                                {{ @$why_choose_us->icon_title_3 }}
                                            </h3>
                                        @endif
                                        <div class="discription">
                                            @if (@$why_choose_us->icon_desc_3 != '')
                                                <p>
                                                    {{ @$why_choose_us->icon_desc_3 }}
                                                </p>
                                            @endif
                                        </div>
                                    </div>
                ...
                <div class="col-xxl-7 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 d-flex justify-content-end">
                    <div class="right-wrapper" data-aos="fade-up">
                        <img src="{{ url('storage/images/whychooseus/image') }}/{{ @$why_choose_us->image }}"
                            class="img-fluid" {!! @$why_choose_us->image_attribute !!}>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- what we do section -->
    <section class="do-wrapper" data-aos="fade-up" id="services">
        <div class="container-ctn">
            <div class="row">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="larg-txt">
                        <h2>Connecting cargo markets and the world</h2>
                    </div>
                </div>
            </div>
            <div class="cargo-slider-wrapper">
                <div class="cargo-slider">
                    @if ($services)
                        @foreach ($services as $key => $service)
                            <div>
                                <div class="solution-wrapper-content">
                                    <div class="solution-box">
                                        <div class="solution-img">
                                            <img src="{{ url('storage/images/service/') }}/{{ @$service->image_webp }}"
                                                class="img-fluid" {!! @$service->image_attribute !!}>
                                        </div>
                                        <div class="solution-content-area">
                                            ...
                                            @if (@$service->description != '')
                                                <div class="small-discription" data-match-height="groupName">
                                    ...
                                    <div class="overlay">
                                        <div class="text">
                                            <div class="ovr-img">
                                                <img src="{{ url('storage/images/service/') }}/{{ @$service->image_webp }}"
                                                    {!! @$service->image_attribute !!}>
                                            </div>
                                            <div class="overlay-area">
                                                <div class="cargo-img">
                                                    <img src="{{ url('storage/images/service/') }}/{{ @$service->icon_webp }}"
                                                        class="img-fluid" {!! @$service->icon_attribute !!} />
                                                </div>
                                                @if (@$service->title != '')
                                                    <a href="javascript:void(0);" class="text-decoration-none"
                                                    >
                                                        <h3 data-bs-toggle="tooltip">{{ @$service->title }}</h3>
                                                    </a>
                                                @endif
                                            </div>
                                        </div>
    ...
    <!-- contact wrapper -->
    <section class="cont-wrapper" data-aos="fade-up" id="contact">
        <div class="common-container-right">
            <div class="row">
                <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12">
                    <div class="left-form">
                        ...
                        <div class="larg-txt f-tagline">
                            <h2>get in touch with us</h2>
                        </div>
                        <div class="contact-form course-enqury-wrapper">
                            <div class="course-eq-box">
                                <form class="enq-form" id="enquiry-form" method="POST"
                                    enctype="multipart/form-data" action="{{ route('enquiry.form') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="filed-btm">
                                                ...
                                                <div id="error-name" class="error-message">Please enter your full
                                                    name.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="filed-btm">
                                                ...
                                                <div id="error-email" class="error-message">Please enter your email
                                                    address.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="filed-btm">
                                                ...
                                                <input type="text" name="phone" class="form-control"
                                                    id="number" placeholder="+1 000 000 00" />
                                                <div class="filed-icon">
                                                    <img src="{{ url('assets/web/images/icons/form-phone.svg') }}"
                                                        class="img-fluid" alt="field" />
                                                </div>
                                                <div id="error-number" class="error-message">Please enter your phone
                                                    number.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="filed-btm">
                                                ...
                                                <div id="error-service" class="error-message">Please select services
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="filed-btm">
                                                ...
                                                <div class="filed-icon">
                                                    <img src="{{ url('assets/web/images/icons/form-msg.svg') }}"
                                                        class="img-fluid" alt="field" />
                                                </div>
                                                <div id="error-msg" class="error-message">Please enter message</div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="filed-btm mt-4 mb-0">
                                                <div
                                                    class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12  waves-effect waves-light initial-btn">
                                                    <div class="red-btn-bg ">
                                                        <!-- <a href="" >Send</a> -->
                                                        <button type="submit"
                                                            class="red-btn text-decoration-none">Send
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-6 col-sm-12 col-12">
                    <div class="mask-img">
                        <img src="{{ url('assets/web/images/contact-img.png') }}" class="img-fluid"
                            alt="contact" />
                    </div>
                </div>
            </div>
    ...
    <section class="get-wrapper">
        <div class="container-ctn">
            <div class="row align-items-center">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 d-flex justify-content-end">
                    <div class="right-conteten">
                        <div class="red-btn-bg waves-effect waves-light">
                            <a href="#contact" class="red-btn text-decoration-none">Contact</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="footer-right-box">
                        <div class="footer-logo">
                            <a href="{{ url('/') }}" class="text-decoration-none">
                                <img src="{{ url('storage/site_information/footer_logo/') . '/' . (isset($siteInformation->footer_logo_webp) ? $siteInformation->footer_logo_webp : '') }}"
                                    class="img-fluid" {!! (isset($siteInformation->footer_logo_attribute) ? $siteInformation->footer_logo_attribute : '') !!} />
                            </a>
                        </div>
                        <div class="discription">
                            <p>
                                {!! (isset($siteInformation->footer_text) ? $siteInformation->footer_text : '') !!}
                            </p>
                        </div>
                        <ul class="list-inline mb-0 social-action">
                            <!-- <li class="list-inline-item">
                    ...
                    <div class="footer-content">
                        ...
                        <div class="foo-links">
                            <ul class="list-inline mb-0 li-img">
                                <li>
                                    <a href="#home" class="nav-link text-decoration-none">Home</a>
                                </li>
                                <li>
                                    <a href="#counter" class="nav-link text-decoration-none">About</a>
                                </li>
                                <li>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-4 col-12">
                    <div class="footer-content">
                        ...
                        <div class="call-info">
                            <p>Feel free to contact us for any inquiries or assistance. We're here to help and provide the best solutions for your needs.</p>
                        </div>
                        <div class="adress">
                                            ...
                                            <div class="call-1">
                                                @if($siteInformation->phone)
                                                    <a href="tel:{{ @$siteInformation->phone }}"
                                                        class="text-decoration-none">
                                                        {{ @$siteInformation->phone }}@if($siteInformation->landline), @endif
                                                    </a>
                                                @endif
                                            </div>
                                            <div class="call-2">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="fixedWrapper">
                        ...
                        @if ($siteInformation->phone)
                            <a class="a-width animateBox" href="tel:{{ $siteInformation->phone }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="filed-btm">
                                                <label for="email" class="form-label">Email address</label>
                                                <input type="text" class="form-control" name="email"
                                                    id="modal_email" placeholder="E-mail Address" />
                                                <div class="filed-icon">
                                                    <img src="{{ url('assets/web/images/icons/form-email.svg') }}"
                                                        class="img-fluid" alt="field" />
                                                </div>
    ...
    <div class="modal fade shiping-modal" id="ship-track-modal" tabindex="-1" aria-labelledby="EnquiryModalLabel"
        ...
        <div class="modal-dialog modal-xxl modal-xl modal-lg modal-md modal-sm-12 modal-dialog-centered">
            <div class="modal-content en-modal-form">
                ...
                <div class="modal-two">
                    <div class="row">
                        <div class="col-xxl-9 col-xl-9 col-lg-12 col-md-12  col-sm-12 col-12 tracking-wrapper">
                            <div class="title">
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6  col-sm-6 col-12 track-map-img">
                            <div class="track-map">
    ...
    <!-- <script src="{{ url('assets/web/js/slick.min.js') }}"></script> -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.0/slick.min.js"></script>
    <script src="{{ url('assets/web/js/main.js') }}"></script>
    <script src="{{ url('assets/web/js/equal-height.js') }}"></script>
    <script src="{{ url('assets/web/js/error-msg-form.js') }}"></script>
    <script src="{{ url('assets/web/js/modal-error-msg.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.js"></script>
    <script src="{{ url('assets/web/js/countup.js') }}"></script>
