...
<style>
    ...
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light"><a href="{{ url('admin/home/slider') }}">Slider </a>/</span> Edit Slider
    </h4>
    <div class="row">
        <!-- FormValidation -->
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="formValidationSliderEdit"
                        action="{{ route('slider.update', ['slider' => $slider->id]) }}" class="row g-3"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="title" class="form-control"
                                value="{{ old('title', isset($slider) ? $slider->title : '') }}" placeholder="Title"
                                name="title" />
                            @error('title')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="sub_title"
                                value="{{ old('sub_title', isset($slider) ? $slider->sub_title : '') }}" class="form-control"
                        ...
                        <div class="col-md-6">
                            @if ($slider->image_webp)
                                <div class="image_box">
                                    <img src="{{ url('storage/images/slider') . '/' . $slider->image_webp }}" width="100px"
                                        alt="image">
                                </div>
                            @endif
                            ...
                            <div class="input-group custom-file">
                                <input class="form-control" type="file" id="image" name="image"
                                    value="{{ old('image', isset($slider) ? $slider->image : '') }}">
                        ...
                        <div class="col-md-6 column_align">
                            ...
                            <input type="text" id="image_attribute"
                                value="{{ old('image_attribute', isset($slider) ? $slider->image_attribute : '') }}"
