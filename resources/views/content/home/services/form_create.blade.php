...
<style>
    ...
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light"><a href="{{ route('service.index') }}">Services </a>/</span></span>
        Create Service
    </h4>
    <div class="row">
        <!-- FormValidation -->
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="formValidationServiceCreate" action="{{ route('service.store') }}" class="row g-3"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea type="description" class="form-control required" min="0" maxlength="160" id="description"
                                    name="description" placeholder="Description" >{{ old('description', isset($service) ? $service->description : '') }}</textarea>
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-md-6">
                                ...
                                <img width="200px" src="{{ old('image', isset($service) ? $service->image : '') }}" alt="">
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-md-6">
                                ...
                                <img width="200px" src="{{ old('icon', isset($service) ? $service->icon : '') }}" alt="">
                                <div class="file-loading">
