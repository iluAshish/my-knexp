    ...
    <div class="container">
        <div class="row">
            <h4 class="py-3 mb-4">
                ...
                <span class="text-muted fw-light"><a href="{{ route('day.list') }}">Days</a> / Create</span>
            </h4>
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Create New Day</h5>
                </div>
                <div class="card-body">

                    <form class="add-new-user pt-0 needs-validation" id="addNewDayForm"
                        action="{{ route('day.store') }}" method="POST">
                        @csrf

                        <div class="mb-3">
                            <label for="week_days" class="form-label">Select Day</label>
